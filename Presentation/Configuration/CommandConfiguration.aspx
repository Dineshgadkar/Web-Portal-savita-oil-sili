<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="CommandConfiguration.aspx.cs" Inherits="Presentation_Configuration_CommandConfiguration" %>
    ...
    <div class="content-wrapper" id="bodyDiv">
        ...
        <div class="content-header box-header with-border" style="margin-left: 20px;">
            ...
            <div id="Div1" class="panel panel-primary" runat="server" style="margin-left: 15%; width: 70%; margin-bottom: auto; margin-top: 1%;">
                ...
                <div class="panel-heading">Create Command
                </div>
                ...
                <div class="panel-body" style="margin-top: 5%; margin-bottom: 5%; padding-left: 12%;">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <asp:TextBox ID="txtCommand" runat="server" CssClass="form-control" Text=""></asp:TextBox>
                            <span>
                                <asp:RequiredFieldValidator ID="RequiredCommand" ErrorMessage="Please Enter Command No " ForeColor="Red" ControlToValidate="txtCommand" runat="server"></asp:RequiredFieldValidator>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <asp:Button ID="btnAdd" runat="server" Text="ADD" CssClass="btn btn-primary"  Style="margin-top: 12%; width: 80%; font-family: Gotham; font-weight: 500" OnClick="btnAdd_Click" />
                    </div>
