...
public partial class Presentation_StandardReports_DDUWorkTimeReport : System.Web.UI.Page
{
    ...
    private void getDDUName()
    {
        try
        {
            ...
            ddl_DDU.DataSource = dt;

            ddl_DDU.DataTextField = "DDSName";
            ddl_DDU.DataValueField = "DDSNo";

            ddl_DDU.DataBind();

            ddl_DDU.Items.Insert(0, "Select DDU");
        }
        catch (Exception ex)
        {
            this.LogError(ex);
    ...
    private void getBlenderName()
    {
        try
        {
            string dduName = ddl_DDU.SelectedValue;
            DataTable dt = new DataTable();
            if (dduName != "Select DDU")
            {

                dt = BAL.getBlenderDataDDU(dduName);
                ...
                ddl_Blender.Items.Insert(1, "Select All");
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        ...
        string ddu = ddl_DDU.SelectedValue;
        string blenderName = ddl_Blender.SelectedValue;

        //

        
        //string blenderName = "";
        //foreach (ListItem li in ddl_Blender.Items)
        //{
        //    if (li.Selected == true)
        //    {
        //        if (blenderName == "")
        ...
        //        else
        //        {
        //            blenderName = blenderName + "," + li.Text;
        //        }
        //    }
        //}
        ...
        try
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Presentation/Reports/DDUWorkTime.rdlc";

            dataset = BAL.getDDUWorkTimeData(sdate, edate, ddu, blenderName);
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        report.ReportPath = "Presentation/Reports/DDUWorkTime.rdlc";
    ...
    protected void ddl_DDU_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            getBlenderName();
