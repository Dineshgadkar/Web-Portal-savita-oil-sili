...
public partial class Presentation_StandardReports_CumulativeBlendingReport : System.Web.UI.Page
{
    DataTable dataset;
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Presentation/Reports/CumulativeBlendReport.rdlc";

            dataset = BAL.getCumulativeBlendingData(sDate, eDate);

            DataColumn dcFromDate = new DataColumn("StartDate", typeof(string));
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        report.ReportPath = "Presentation/Reports/CumulativeBlendReport.rdlc";
