...
public partial class Presentation_StandardReports_PickListDDU : System.Web.UI.Page
{
    ...
    private void loadReport()
    {
        try
        {
            dtProdListData = BAL.GetPickListDDU();

            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = "Presentation/Reports/PickList_ddu.rdlc";

            ReportDataSource datasource = new ReportDataSource("DataSet1", dtProdListData);
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        report.ReportPath = "Presentation/Reports/PickList_ddu.rdlc";
        loadReport();
        report.DataSources.Add(new ReportDataSource("DataSet1", dtProdListData));
