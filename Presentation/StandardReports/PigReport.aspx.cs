...
public partial class Presentation_StandardReports_PigReport : System.Web.UI.Page
{
    DataTable dataset;
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            report.ReportPath = "Presentation/Reports/PigReport.rdlc";
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        ...
        ReportViewer1.LocalReport.ReportPath = "Presentation/Reports/PigReport.rdlc"; //Report rdlc path

        string ViewName = BAL.getPigTable(SelectedArea);

        dataset = BAL.getPigData(FromDate, ToDate, ViewName, SelectedArea);
