<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="CumulativeConsumptionReport.aspx.cs" Inherits="Presentation_StandardReports_CumulativeConsumptionReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper" id="bodyDiv" style="height: 1170px;">
        <section class="content-header">
            <h1>Cumulative Consumption Report
            </h1>
            ...
            <ContentTemplate>
                ...
                <div class="content-header box-header with-border">
                    ...
                    <div class="col-md-3">
                        ...
                        <asp:TextBox ID="txtFromDate" runat="server" CssClass="form-control" OnTextChanged="txtFromDate_TextChanged" autocomplete="off"></asp:TextBox>
