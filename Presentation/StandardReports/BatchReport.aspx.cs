...
public partial class Presentation_StandardReports_BatchReport : System.Web.UI.Page
{
    string connetionString = null;
    public string blender_Name = "";
    ...
    private void GetData()
    {
        try
        {
            ...
            dt = BAL.getBlenderData(); //Get All Blender Names for Selection
    ...
    protected void ddl_Vessel_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            DataTable dt = BAL.getProductList(blender_Name); // Get Products as per the Selected Blender
    ...
    protected void ddl_ProdCode_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            blender_Name = ddl_Vessel.SelectedValue;
            prdName = ddl_ProdCode.SelectedValue;

            DataTable dt = new DataTable();
            dt = BAL.getBatchList(blender_Name, prdName);  //Get Batch No as per the BatchNo and Product Name selection
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            blender_Name = ddl_Vessel.SelectedValue;
            string ves_Name = ddl_Vessel.SelectedItem.Text;
            prdName = ddl_ProdCode.Text;

            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = "Presentation/Reports/BatchReports/BatchReport.rdlc"; //Report rdlc path
            //ReportViewer1.LocalReport.ReportPath = "Presentation/Reports/BatchReports/123.rdlc"; //Report rdlc path
            dataset = new DataTable();
            dataset = BAL.getReportData(blender_Name, prdName, btchName); //Get Batch Report data 

            #region Not Used

            //DataTable dtxyz = new DataTable();

            //string BlenderName = ves_Name;
            ...
            //string ProdcedQty = Convert.ToString(dataset.Rows[0]["ProducedQty"]);

            //string TYPE = Convert.ToString(dataset.Rows[0]["TypeDesc"]);

            #endregion

            ReportDataSource datasource = new ReportDataSource("V101", dataset);
            ReportViewer1.LocalReport.EnableHyperlinks = true;
            ReportViewer1.LocalReport.DataSources.Clear();
            ReportViewer1.LocalReport.DataSources.Add(datasource);
            ReportViewer1.LocalReport.Refresh();

            #region Report Paramters addition Programmatically Not Used
            ...
            //param[3] = new ReportParameter("FinalBlenderWt", BTCH_SIZE_PV);
