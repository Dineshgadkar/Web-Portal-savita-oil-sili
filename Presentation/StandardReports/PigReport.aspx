<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="PigReport.aspx.cs" Inherits="Presentation_StandardReports_PigReport" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="col-md-3">
                        ...
                        <asp:DropDownList ID="ddl_Area" runat="server" CssClass="form-control" AutoPostBack="true">
                            <asp:ListItem>Unloading A</asp:ListItem>
                            <asp:ListItem>Unloading B</asp:ListItem>
                            <asp:ListItem>RM WO Plant B</asp:ListItem>
                            <asp:ListItem>RM TO Plant A</asp:ListItem>
                            <asp:ListItem>TO Header A Warehouse</asp:ListItem>
                            <asp:ListItem>TO Header B Warehouse</asp:ListItem>
                            <asp:ListItem>WO Header A Warehouse</asp:ListItem>
                            <asp:ListItem>WO Header B Loading Area</asp:ListItem>
                            <asp:ListItem>Header 7</asp:ListItem>
                            <asp:ListItem>Header 8</asp:ListItem>
                        </asp:DropDownList>
