<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="RMConsumptionRMCodeWise.aspx.cs" Inherits="Presentation_StandardReports_RMConsumptionRMCodeWise" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="content-wrapper" id="BodyDiv" style="height: 1170px;">
        <section class="content-header">
            <h1>RM code Wise Consumption Report</h1>
        </section>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="content-header box-header with-border">
                    ...
                    <div class="col-md-3">
                        <b id="bRmCode" runat="server">Select RM Code :</b>
                        <asp:DropDownList ID="ddlRMCode" runat="server" CssClass="form-control">
                        </asp:DropDownList>
                    </div>
