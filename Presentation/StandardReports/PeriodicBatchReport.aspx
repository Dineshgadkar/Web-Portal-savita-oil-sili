<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="PeriodicBatchReport.aspx.cs" Inherits="Presentation_StandardReports_PeriodicBatchReport" %>
                            ...
                            <div class="box">
                                <!-- Custom tabs (Charts with tabs)-->
                                    ...
                                    <div id="head" style="height:600px;">
                                         <rsweb:ReportViewer ID="ReportViewer1" Style="width: auto; height: auto;" runat="server" Font-Names="Verdana" Font-Size="8pt"  WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
