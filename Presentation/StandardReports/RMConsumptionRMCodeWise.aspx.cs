...
public partial class Presentation_StandardReports_RMConsumptionRMCodeWise : System.Web.UI.Page
{
    string fdtm = "";
    string tdtm = "";
    ...
    private void getRMCode()
    {
        try
        {
            DataTable dt = new DataTable();

            dt = BAL.getRMCodeData();

            ddlRMCode.DataSource = dt;
            ddlRMCode.DataValueField = "PRODUCT";
            ddlRMCode.DataTextField = "PRODUCT";
            ddlRMCode.DataBind();

            ddlRMCode.Items.Insert(0,"Select RM Code");
        }
        catch (Exception ex)
        {
            this.LogError(ex);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        ...
        tdtm = txtToDate.Text;
        string RMCode = ddlRMCode.SelectedItem.Text;
        ...
        try
        {
            ...
            dataset = BAL.getRMConsDataFilter(fdtm,tdtm,RMCode,"RMWise");
