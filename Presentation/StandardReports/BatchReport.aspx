<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="BatchReport.aspx.cs" Inherits="Presentation_StandardReports_BatchReport" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <ContentTemplate>
                    ...
                    <div class="col-md-3">
                        ...
                        <asp:DropDownList ID="ddl_ProdCode" AutoPostBack="true" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddl_ProdCode_SelectedIndexChanged">
                        </asp:DropDownList>
