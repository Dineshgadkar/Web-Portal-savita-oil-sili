<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="CumulativeBlenderWise.aspx.cs" Inherits="Presentation_StandardReports_CumulativeBlenderWise" %>
    ...
    <div class="content-wrapper" id="bodyDiv" style="height: 1170px;">
        ...
        <div class="content-header box-header with-border">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="col-md-3">
                        <b id="B2" runat="server">Blender Name : </b>

                        <asp:DropDownList ID="ddl_Blender" AutoPostBack="true" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddl_Blender_SelectedIndexChanged">
                        </asp:DropDownList>
                    </div>
