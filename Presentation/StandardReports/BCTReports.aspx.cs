...
public partial class Presentation_StandardReports_BCTReports : System.Web.UI.Page
{
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Presentation/Reports/BatchReports/BCTReport.rdlc";

            dataset = new DataTable();
            dataset = BAL.getBCTData(blender_Name, FDate, EDate);
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        report.ReportPath = "Presentation/Reports/BatchReports/BCTReport.rdlc";
