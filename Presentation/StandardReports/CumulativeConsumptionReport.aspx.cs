...
public partial class Presentation_StandardReports_CumulativeConsumptionReport : System.Web.UI.Page
{
    string fdtm = "";
    string tdtm = "";
    DataTable dataset;
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ReportViewer1.LocalReport.ReportPath = "Presentation/Reports/CumulativeRMConsumptionReport.rdlc";

            dataset = BAL.getCumulativeConsData(fdtm, tdtm);
            ...
            param[0] = new ReportParameter("FromDate", fdtm);
            param[1] = new ReportParameter("ToDate", tdtm);
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        report.ReportPath = "Presentation/Reports/CumulativeRMConsumptionReport.rdlc";
