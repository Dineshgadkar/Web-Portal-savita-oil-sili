...
public partial class Presentation_StandardReports_RMConsumptionBlenderWise : System.Web.UI.Page
{
    string fdtm = "";
    string tdtm = "";
    ...
    private void getBlenderName()
    {
        try
        {
            ...
            ddlBlender.DataSource = dt;
            ddlBlender.DataValueField = "BlenderName";
            ddlBlender.DataTextField = "BlenderName";
            ddlBlender.DataBind();

            ddlBlender.Items.Insert(0, "Select Blender");
        }
        catch (Exception ex)
        {
            this.LogError(ex);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        ...
        tdtm = txtToDate.Text;
        string Tank = ddlBlender.SelectedItem.Text;
        ...
        try
        {
            ...
            dataset = BAL.getRMConsDataFilter(fdtm, tdtm, Tank, "BlenderWise");
