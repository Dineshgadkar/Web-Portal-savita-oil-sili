...
public partial class Presentation_StandardReports_CumulativeFamilyWise : System.Web.UI.Page
{
    string FamilyName = "";
    ...
    public void getFamilyName()
    {
        try
        {
            ...
            dt = BAL.getFamilyName();

            ddl_FamilyName.DataSource = dt;

            ddl_FamilyName.DataTextField = "FamilyName";
            ddl_FamilyName.DataValueField = "FamilyName";

            ddl_FamilyName.DataBind();

            ddl_FamilyName.Items.Insert(0, "Select Product Family Name");
        }
        catch (Exception ex)
        {
            this.LogError(ex);
    ...
    protected void ddl_FamilyName_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            FamilyName = ddl_FamilyName.SelectedValue;
            DataTable dt = new DataTable();
            dt = BAL.getFamilyData(FamilyName);
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            dataset = BAL.getCumulativeReportData(FamilyName, BatchNo);

            #region Commented Data Fetching
            ...
            //string BlenderNo = Convert.ToString(dataset.Rows[0]["BlenderName"]);;
            ...
            #region Commented Add Parameters programatically
