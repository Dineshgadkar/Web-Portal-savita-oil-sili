...
public partial class Presentation_StandardReports_BCTReportProductWise : System.Web.UI.Page
{
    ...
    private void GetData()
    {
        try
        {
            ...
            dt = BAL.GetProductListData();

            DataTable dtBlenderData = new DataTable();

            dtBlenderData = BAL.getBlenderData();

            ddl_Product.DataSource = dt;

            ddl_Product.DataTextField = "ProductCode";
            ddl_Product.DataValueField = "ProductCode";
            ddl_Product.DataBind();

            ddl_Product.Items.Insert(0, "Select Product Name");

            ddl_Vessel.DataSource = dtBlenderData;
    ...
    protected void btn_Submit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string blender = ddl_Vessel.SelectedValue;

            ReportViewer1.ProcessingMode = ProcessingMode.Local;
            ReportViewer1.LocalReport.ReportPath = "Presentation/Reports/BatchReports/ProductWiseBCTReport.rdlc";

            dataset = BAL.getProductWiseBCT(Product, FDate, EDate, blender);

            ReportDataSource datasource = new ReportDataSource("V103", dataset);
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        ...
        report.ReportPath = "Presentation/Reports/BatchReports/ProductWiseBCTReport.rdlc";
        btn_Submit_Click(new object(), new EventArgs());
        report.DataSources.Add(new ReportDataSource("V103", dataset));
